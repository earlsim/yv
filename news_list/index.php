...
$APPLICATION->SetPageProperty("keywords_inner", "YVOIRE");
$APPLICATION->SetPageProperty("title", "YVOIRE - News");
$APPLICATION->SetPageProperty("keywords", "YVOIRE");
$APPLICATION->SetPageProperty("description", "YVOIRE");
$APPLICATION->SetTitle("YVOIRE News");
?><script>
    $(function () {
        newsLoader.listInit();
    });
...
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"DETAIL_PROPERTY_CODE" => array("","CONTENT_PICTURE",""),
