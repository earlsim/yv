    ...
    <div class="container subPage ctx_lggroup">
        ...
        <div class="contents">
            ...
            <div class="lggroup_view">
                    ...
                    <ul>
                        <li>
                            <div class="tit_box mobile">
                                <p class="tit">Twin Tower</p>
                                <p class="subtit">LG Head quarter</p>
                            </div>
                ...
                <div class="science">
                    <div class="tit_box mobile">
                        <p class="tit pc">LG Science Park</p>
                    </div>
                    ...
                    <div class="science_txt">
                        ...
                        <div class="notice">
                            <ul>
                                <li>
                                    <p>
                                        LG believes that the key value for a preemptive response to the 4th industrial
                                        revolution era is [the creation of integrated technology which led us to
                                        establish
                                        a research complex for researchers from various fields to collaborate in
                                        creating innovations.
                                        LG Sciencepark will be a hub for R&D talented individuals in electronics,
                                        chemicals,
                                        biotechnology, software, and telecommunications to create technology for Korea
                                        and LG's
                                        continuing growth.
                                    </p>
                                </li>
                                <li>
                                    <p>
                                        LG Sciencepark provides the best research and welfare facilities and supports
                                        collaborative
                                        research with leading overseas companies, small and medium-sized venture
                                        companies,
                                        and academia in order to create an environment where the boundaries between
                                        technologies blur,
                                        and groundbreaking research can be performed.
                                    </p>
                                </li>
                            </ul>
                        </div>
