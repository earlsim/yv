...
<div class="container subPage ctx_newsview">
 ...
 <span class="page_navi left"><a href="/sns/"><img alt="LEFT PAGE" src="/local/templates/yvoire/images/icon/page_navigator_left.png"></a></span> <span class="page_navi right"><a href="/faq/"><img alt="RIGHT PAGE" src="/local/templates/yvoire/images/icon/page_navigator_right.png"></a></span>
			</div>
		</div>
	</div>
	 <!-- //sub visual --> <!-- contents -->
 ...
 <input type="hidden" name="lang" value="ko"> <input type="hidden" name="page" id="page" value="1"> <input type="hidden" name="bt" value="1">
					</form>
