...
<div class="mobile-filters js-mobile-filters">Фильтры</div>
...
<?foreach($arResult["ITEMS"] as $arItem):?>
	...
	?>
	<div class="events-item" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
...
//				?>
<!--				<div class="bx-newslist-date"> --><?//=GetMessage("IBLOCK_FIELD_".$code)?><!--:-->
<!--					--><?//=$value;?>
<!--				</div>-->
