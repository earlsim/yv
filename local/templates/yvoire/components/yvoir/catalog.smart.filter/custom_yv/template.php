		...
		<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
			...
			foreach($arResult["ITEMS"] as $key=>$arItem)
			{
				...
				<div class="bx_filter_parameters_box <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>active<?endif?>">
					<span class="bx_filter_container_modef"></span>
					<div class="nav-title" ><?=$arItem["NAME"]?></div> <!--onclick="smartFilter.hideFilterProps(this)"-->
					<div class="bx_filter_block">
						<div class="bx_filter_parameters_box_container">
						<?
                        ...
                        <?
                            ...
                            <div class="nav-options">
                                ...
                                <li class="topic-option">
									<label data-role="label_<?=$ar["CONTROL_ID"]?>" class="fw300 <? echo $ar["DISABLED"] ? 'disabled': '' ?>" for="<? echo $ar["CONTROL_ID"] ?>">
											<input
                                                class="nav-topic__input"
												type="checkbox"
											...
											/>
                                            <span class="nav-topic__check"></span><?=$ar["VALUE"];?>
